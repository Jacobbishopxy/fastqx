...
pub trait FqxD: Sized {
    type ColumnsT: SeqSlice + SeqAppend<String> + Debug + Clone + Eq + Hash;
    type TypesT: SeqSlice + SeqAppend<FqxValueType> + Debug + Clone + Eq;
    type RowT: SeqSlice + RowProps + Debug;

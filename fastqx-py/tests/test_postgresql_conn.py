# @file:	test_postgresql_conn.py
# @author:	Jacob Xie
# @date:	2023/10/18 10:02:28 Wednesday
# @brief:
...
PG_SQL_CONN = os.getenv("PG_SQL_CONN")
if PG_SQL_CONN is None:
    raise FileNotFoundError(".env file is missing or `MS_SQL_CONN` is not set")

connector = FqxSqlConnector(PG_SQL_CONN)
